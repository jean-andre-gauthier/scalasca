...
//
//case class NullPointerAnalysisMap(map: Map[Global#Symbol]) extends RuleResult {
//
...
//}
//
//case class NullPointerAnalysisTraversalState(inMembers: Boolean, mutableFields: List[Global#Symbol]) extends TraversalState
//
///**
